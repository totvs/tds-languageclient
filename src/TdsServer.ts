import createIMessageConnection from "./createTdsMessageConnection";
import { BuildVersion, ITdsMessageConnection } from "./types";
...
export default class TdsServer {
    ...
    protected connection: ITdsMessageConnection = null;

    public constructor(connection?: ITdsMessageConnection) {
        if (connection) {
            this.connection = connection;
        }
        else {
            this.connection = createIMessageConnection(false);
        }
    }
